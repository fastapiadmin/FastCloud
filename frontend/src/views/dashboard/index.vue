        ...
        <div class="hidden sm:block">
          <div class="flex items-end space-x-6">
            ...
            <div class="flex flex-col items-center">
              ...
              <div class="mt-3 whitespace-nowrap">
                <el-link href="https://gitee.com/fastapiadmin/FastCloud" target="_blank">
                  <div class="i-svg:gitee text-lg color-#F76560" />
                </el-link>
                <el-divider direction="vertical" />
                <el-link href="https://github.com/fastapiadmin/FastCloud" target="_blank">
          ...
          <template #header>
            <div class="flex-x-between">
              ...
              <el-link
                type="primary"
                underline="never"
                href="https://gitee.com/fastapiadmin/FastCloud/releases"
                target="_blank"
              >
                完整记录
...
const vesionList = ref<VersionItem[]>([
  {
    ...
    link: "https://gitee.com/fastapiadmin/FastCloud/releases",
    tag: "更新",
  },
  {
    id: "2",
