        ...
        >
          ...
          <div v-else class="workplace-logs-scroll">
            ...
            >
              ...
              <el-table-column label="IP" prop="request_ip" min-width="100" show-overflow-tooltip />
              <el-table-column
                label="时间"
                prop="created_time"
                min-width="136"
...
async function fetchWorkplaceStats() {
  ...
  try {
    const [userR] = await Promise.allSettled([UserAPI.listUser({ page_no: 1, page_size: 1 })]);
