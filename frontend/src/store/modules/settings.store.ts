...
export const useSettingsStore = defineStore("setting", () => {
  ...
  // 🎯 界面显示设置 - 持久化
  const title = useStorage<string>(SETTINGS_KEYS.TITLE, defaultSettings.title);
  const version = useStorage<string>(SETTINGS_KEYS.VERSION, defaultSettings.version);
  ...
  function resetSettings(): void {
    ...
    version.value = defaultSettings.version;
